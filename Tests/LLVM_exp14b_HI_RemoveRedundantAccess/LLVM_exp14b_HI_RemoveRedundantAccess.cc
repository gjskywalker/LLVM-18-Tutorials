#include "LLVM_exp14b_HI_RemoveRedundantAccess.h"
...
int main(int argc, char **argv)
{
    ...
    auto hi_remove_redundant_access = new HI_RemoveRedundantAccess("HI_RemoveRedundantAccess", top_str.c_str(), true);
    print_info("Enable HI_RemoveRedundantAccess Pass");
    PM.add(hi_remove_redundant_access);
